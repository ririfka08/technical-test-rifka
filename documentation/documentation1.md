# Documentation Manual Testing Fitur Mark as Favourite (Indonesian Language Preferences)
## User Story
I have changed language to Indonesian. As a logged-in user of TMDb, I want to mark movies as my favorites. So that I can easily access and manage my list of favorite movies
